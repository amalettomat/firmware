...
#define SCRAPER_SPEED_REV (200 * SCRAPER_MICROSTEPS)
#define SCRAPER_ACCELARATION (2000 * SCRAPER_MICROSTEPS)
#define SCRAPER_DIST (3150 * SCRAPER_MICROSTEPS)
...
#define MIN_PRESSURE 0.6F
#define MAX_PRESSURE 1.2F
#define MIN_PRESSURE_FOR_START 1.0F
...
// EEPROM
#define EEPROM_MARKER_VALUE 0xABAF

#define EEPROM_IDX_MARKER 0
#define EEPROM_IDX_COUNTER 2
#define EEPROM_IDX_PRICE 6
#define EEPROM_IDX_BAKING_TIME 10
#define EEPROM_IDX_BATTER_AMOUNT 14
#define EEPROM_IDX_FILLING1 18
#define EEPROM_IDX_FILLING2 22
